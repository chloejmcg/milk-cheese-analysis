...
head(sample_data(scaled_physeq)) # nope no cheese_type...time to add!

# Step 1: Extract metadata as data.frame
sample_meta <- as(sample_data(scaled_physeq), "data.frame")

# Step 2: Create a named vector of cheese types
cheese_type_vec <- c(
  Q4 = "Colonial", Q5 = "Colonial", Q6 = "Colonial", Q7 = "Colonial", Q8 = "Colonial",
  Q1 = "Feta-type", Q10 = "Feta-type", Q2 = "Feta-type", Q3 = "Feta-type", Q9 = "Feta-type",
  Q11 = "Fresh", Q12 = "Fresh", Q13 = "Fresh", Q14 = "Fresh", Q15 = "Fresh",
  Q16 = "Pecorino-type", Q17 = "Pecorino-type", Q18 = "Pecorino-type", Q19 = "Pecorino-type", Q20 = "Pecorino-type"
)

# Step 3: Assign cheese_type to sample_meta using rownames
sample_meta$cheese_type <- cheese_type_vec[rownames(sample_meta)]

# Step 4: Reassign to the phyloseq object
sample_data(scaled_physeq)$cheese_type <- sample_meta$cheese_type

# check 
table(sample_data(scaled_physeq)$cheese_type, useNA = "always")

head(rownames(sample_meta))
names(cheese_type_vec)
